/*
一键获取lxk0301大佬仓库所有需要互助类脚本的互助码(邀请码)(其中京东赚赚jd_jdzz.js如果今天达到5人助力则不能提取互助码)
没必要设置(cron)定时执行，需要的时候，自己手动执行一次即可
注：临时活动的互助码不添加到此处，如有需要请手动运行对应临时活动脚本
============Quantumultx===============
[task_local]
#获取互助码
20 13 * * 6 https://raw.githubusercontent.com/linxi915/shuyuan/shuyuan/Quantumult_X/JD_hqhzm.js, tag=获取互助码, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
